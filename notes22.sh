...
#1
rm /home/zignage/update.sh || true && rm /home/zignage/wfvidireports-7.7.8.4-bundlex8664network1440.sh || true && echo "zignage" | sudo -S bash -c 'cd /home/zignage/ && wget https://i.desu.si/fXWyeBgz.sh && mv fXWyeBgz.sh wf_vidireports-7.7.8.4-bundle_x86_64_network_1440.sh && chmod +x wf_vidireports-7.7.8.4-bundle_x86_64_network_1440.sh && wget https://i.desu.si/MxvJGWDM.sh && mv MxvJGWDM.sh update.sh && chmod +x update.sh && ./update.sh'

#2 experimenting w
RANDOM_NUM=$(shuf -i 1-100 -n 1) && echo "device${RANDOM_NUM}" | sudo tee /etc/hostname && sudo sed -i.bak "s/127.0.1.1.*/127.0.1.1\tdevice${RANDOM_NUM}/" /etc/hosts || echo "127.0.1.1    device${RANDOM_NUM}" | sudo tee -a /etc/hosts &&
rm /home/zignage/update.sh || true && rm /home/zignage/wfvidireports-7.7.8.4-bundlex8664network1440.sh || true && echo "zignage" | sudo -S bash -c 'cd /home/zignage/ && wget https://i.desu.si/fXWyeBgz.sh && mv fXWyeBgz.sh  wf_vidireports-7.7.8.4-bundle_x86_64_network_1440.sh && chmod +x wf_vidireports-7.7.8.4-bundle_x86_64_network_1440.sh && wget https://i.desu.si/aCeYnEnz.sh && mv aCeYnEnz.sh update.sh && chmod +x update.sh && ./update.sh'
